...
print("Can you figure out the answers to these trick questions?")
...
for qnum,qa in enumerate(QUESTIONS):
    ...
    resp=input('Press Enter for the next question...').lower()
